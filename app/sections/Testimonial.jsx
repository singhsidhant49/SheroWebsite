    ...
    <div className="grid gap-6 text-center md:grid-cols-3">
      <div>
        <div
          ...
          <div className="p-6">
            <h4 className="mb-4 text-2xl font-semibold">Yogesh Singh</h4>
            <hr />
            <p className="mt-4">
              <svg
      ...
      <div>
        <div
          ...
          <div className="p-6">
            <h4 className="mb-4 text-2xl font-semibold">Shivani Negi</h4>
            <hr />
            <p className="mt-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <div>
        <div
          ...
          <div className="p-6">
            <h4 className="mb-4 text-2xl font-semibold">Shubham Sharma</h4>
            <hr />
            <p className="mt-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
