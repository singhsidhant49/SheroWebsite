          ...
          <Image width={120} height={80} src={sherologo} alt="Shero incorp" className=" mr-3" />
            ...
            <div className="flex items-center">
              ...
              <div className="bg-green-500 text-white h-8 w-8 flex justify-center items-center rounded mx-1">
                <Link target="_blank" href="https://wa.me/919389361060" aria-label="Whatsapp"><FaWhatsapp fontSize={20} className="cursor-pointer" /></Link>
              </div>
          ...
          <div>
            ...
            <div className="flex gap-4   flex-wrap">
              <div className="flex items-center gap-5  md:gap-8">
                ...
                <p className="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600"> <span className="text-xs">Our Address</span> <br />18 Shastri Nagar Dehradun, India </p>
              </div>
              <div className="flex items-center gap-5 md:gap-8">
                <BiPhoneCall fontSize={25} className="cursor-pointer" />
                <p className="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600"> <span className="text-xs">Reach Us Call/whatsaap</span> <br /> <a href="https://wa.me/919389361060">+91 9389361060</a></p>
              </div>
              <div className="flex items-center gap-5 md:gap-8">
